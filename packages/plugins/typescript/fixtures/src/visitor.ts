...
import { FixturesRawPluginConfig } from "./config.js";
...
export interface FixturesPluginConfig extends ClientSideBasePluginConfig {
  link?: {
    endpoint: string;
    name: string;
  };
...
export class FixturesVisitor extends ClientSideBaseVisitor<FixturesRawPluginConfig, FixturesPluginConfig> {
  ...
  constructor(schema: GraphQLSchema, fragments: LoadedFragment[], rawConfig: FixturesRawPluginConfig) {
